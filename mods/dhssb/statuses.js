...
exports.BattleStatuses = {
	...
	uncleflacco: {
		...
		effectType: 'Ability',
		onStart: function () {
			this.add('raw|<div class="chat chatmessage-uncleflacco"><strong style="color:hsl(3,82%,46.53322260126517%);"><small>%</small><span class="username" data-name="UncleFlacco">UncleFlacco</span>:</strong> <em><img src="http://i.imgur.com/v4l4e0o.gif" title="feelsabsol" width="50" height="50"> I love you, " + pokemon.side.name + "!</em></div>');
		},
		onFaint: function(pokemon) {
